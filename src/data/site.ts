...
export const PENDENTE = [
  ...
  'Turbo Deploy (/ferramentas-ia/turbo-deploy/): confirmar a URL de cadastro/login da plataforma. Enquanto isso, os CTAs levam ao WhatsApp para contratar e ativar o plano. https://up.turbo.cloud permanece apenas como referência não confirmada em links.turboDeploy.',
